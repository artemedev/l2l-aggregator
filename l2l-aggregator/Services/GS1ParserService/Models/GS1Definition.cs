...
namespace l2l_aggregator.Services.GS1ParserService.Models
{
    public class GS1Definition
    {
        ...
        public GS1Definition()
        {
            ...
            Add("92", "Company specific", DataType.Alphanumeric, 88, true);
            ...
            Add("97", "Company specific", DataType.Alphanumeric, 64, true);
        ...
        /// <param name="lengthOfData">The max length of the content</param>
