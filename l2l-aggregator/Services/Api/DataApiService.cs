...
namespace l2l_aggregator.Services.Api
{
    ...
    //    public DataApiService(ApiClientFactory apiClientFactory, _database = database;)
    //    {
    ...
    //        var response = await client.UserAuth(new UserAuthRequest
    //        {
    //            wid = login,
    //            spd = password
    //        });
    ...
    //    public async Task<ArmJobInfoRecord?> GetJobInfoAsync(long docId)
    //    {
    //        var client = await _apiClientFactory.CreateClientAsync<ITaskApi>();
    ...
    //    }
    //    //public async Task<ArmJobResponse> LoadJobsAsync(string userId)
    //    //{
    //    //    var client = await _apiClientFactory.CreateClientAsync<ITaskApi>();
    //    //    var request = new ArmJobRequest { userid = userId };
    //    //    return await client.GetJobs(request);
    //    //}

    //    //public async Task<ArmJobInfoRecord?> LoadJobInfoAsync(long docId)
    //    //{
    //    //    var client = await _apiClientFactory.CreateClientAsync<ITaskApi>();
    //    //    var request = new ArmJobInfoRequest { docid = docId };
    //    //    var response = await client.GetJob(request);
    //    //    return response.RECORDSET.FirstOrDefault();
    //    //}
